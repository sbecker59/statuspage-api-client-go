...
func NewPostPagesPageIdPageAccessUsersPageAccessUserIdMetrics(metricIds []string) *PostPagesPageIdPageAccessUsersPageAccessUserIdMetrics {
	this := PostPagesPageIdPageAccessUsersPageAccessUserIdMetrics{}
...
type NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics struct {
	value *PostPagesPageIdPageAccessUsersPageAccessUserIdMetrics
	isSet bool
}

func (v NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics) Get() *PostPagesPageIdPageAccessUsersPageAccessUserIdMetrics {
	return v.value
}

func (v *NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics) Set(val *PostPagesPageIdPageAccessUsersPageAccessUserIdMetrics) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics(val *PostPagesPageIdPageAccessUsersPageAccessUserIdMetrics) *NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics {
	return &NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics{value: val, isSet: true}
}

func (v NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPagesPageIdPageAccessUsersPageAccessUserIdMetrics) UnmarshalJSON(src []byte) error {
	v.isSet = true
