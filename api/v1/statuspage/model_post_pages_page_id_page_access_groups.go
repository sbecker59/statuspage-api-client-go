...
// checks if the PostPagesPageIdPageAccessGroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostPagesPageIdPageAccessGroups{}

// PostPagesPageIdPageAccessGroups Create a page access group
type PostPagesPageIdPageAccessGroups struct {
...
func NewPostPagesPageIdPageAccessGroups() *PostPagesPageIdPageAccessGroups {
	this := PostPagesPageIdPageAccessGroups{}
	return &this
}
...
func (o PostPagesPageIdPageAccessGroups) MarshalJSON() ([]byte, error) {
...
func (o PostPagesPageIdPageAccessGroups) ToMap() (map[string]interface{}, error) {
...
type NullablePostPagesPageIdPageAccessGroups struct {
	value *PostPagesPageIdPageAccessGroups
	isSet bool
}

func (v NullablePostPagesPageIdPageAccessGroups) Get() *PostPagesPageIdPageAccessGroups {
	return v.value
}

func (v *NullablePostPagesPageIdPageAccessGroups) Set(val *PostPagesPageIdPageAccessGroups) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPagesPageIdPageAccessGroups) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPagesPageIdPageAccessGroups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPagesPageIdPageAccessGroups(val *PostPagesPageIdPageAccessGroups) *NullablePostPagesPageIdPageAccessGroups {
	return &NullablePostPagesPageIdPageAccessGroups{value: val, isSet: true}
}

func (v NullablePostPagesPageIdPageAccessGroups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPagesPageIdPageAccessGroups) UnmarshalJSON(src []byte) error {
	v.isSet = true
