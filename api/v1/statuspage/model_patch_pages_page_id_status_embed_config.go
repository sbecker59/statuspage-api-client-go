...
// checks if the PatchPagesPageIdStatusEmbedConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchPagesPageIdStatusEmbedConfig{}

// PatchPagesPageIdStatusEmbedConfig Update status embed config settings
type PatchPagesPageIdStatusEmbedConfig struct {
...
func NewPatchPagesPageIdStatusEmbedConfig() *PatchPagesPageIdStatusEmbedConfig {
	this := PatchPagesPageIdStatusEmbedConfig{}
	return &this
}
...
func (o PatchPagesPageIdStatusEmbedConfig) MarshalJSON() ([]byte, error) {
...
func (o PatchPagesPageIdStatusEmbedConfig) ToMap() (map[string]interface{}, error) {
...
type NullablePatchPagesPageIdStatusEmbedConfig struct {
	value *PatchPagesPageIdStatusEmbedConfig
	isSet bool
}

func (v NullablePatchPagesPageIdStatusEmbedConfig) Get() *PatchPagesPageIdStatusEmbedConfig {
	return v.value
}

func (v *NullablePatchPagesPageIdStatusEmbedConfig) Set(val *PatchPagesPageIdStatusEmbedConfig) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchPagesPageIdStatusEmbedConfig) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchPagesPageIdStatusEmbedConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchPagesPageIdStatusEmbedConfig(val *PatchPagesPageIdStatusEmbedConfig) *NullablePatchPagesPageIdStatusEmbedConfig {
	return &NullablePatchPagesPageIdStatusEmbedConfig{value: val, isSet: true}
}

func (v NullablePatchPagesPageIdStatusEmbedConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchPagesPageIdStatusEmbedConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
