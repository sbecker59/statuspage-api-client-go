...
func (r ApiGetPagesPageIdIncidentTemplatesRequest) Page(page int32) ApiGetPagesPageIdIncidentTemplatesRequest {
	r.page = &page
	return r
}
...
func (r ApiGetPagesPageIdIncidentTemplatesRequest) Execute() ([]IncidentTemplate, *_nethttp.Response, GenericOpenAPIError) {
	return r.ApiService.GetPagesPageIdIncidentTemplatesExecute(r)
}

/*
 * GetPagesPageIdIncidentTemplates Get a list of templates
 ...
 */
func (a *TemplatesApiService) GetPagesPageIdIncidentTemplatesExecute(r ApiGetPagesPageIdIncidentTemplatesRequest) ([]IncidentTemplate, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiPostPagesPageIdIncidentTemplatesRequest) PostPagesPageIdIncidentTemplates(postPagesPageIdIncidentTemplates PostPagesPageIdIncidentTemplates) ApiPostPagesPageIdIncidentTemplatesRequest {
	r.postPagesPageIdIncidentTemplates = &postPagesPageIdIncidentTemplates
	return r
}

func (r ApiPostPagesPageIdIncidentTemplatesRequest) Execute() (IncidentTemplate, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return IncidentTemplate
 */
func (a *TemplatesApiService) PostPagesPageIdIncidentTemplatesExecute(r ApiPostPagesPageIdIncidentTemplatesRequest) (IncidentTemplate, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	if r.postPagesPageIdIncidentTemplates == nil {
		executionError.error = "postPagesPageIdIncidentTemplates is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
	...
	// body params
	localVarPostBody = r.postPagesPageIdIncidentTemplates
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["api_key"]; ok {
