...
// checks if the PageAccessGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageAccessGroup{}
...
func (o PageAccessGroup) MarshalJSON() ([]byte, error) {
...
func (o PageAccessGroup) ToMap() (map[string]interface{}, error) {
...
type NullablePageAccessGroup struct {
	value *PageAccessGroup
	isSet bool
}

func (v NullablePageAccessGroup) Get() *PageAccessGroup {
	return v.value
}

func (v *NullablePageAccessGroup) Set(val *PageAccessGroup) {
	v.value = val
	v.isSet = true
}

func (v NullablePageAccessGroup) IsSet() bool {
	return v.isSet
}

func (v *NullablePageAccessGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageAccessGroup(val *PageAccessGroup) *NullablePageAccessGroup {
	return &NullablePageAccessGroup{value: val, isSet: true}
}

func (v NullablePageAccessGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageAccessGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
