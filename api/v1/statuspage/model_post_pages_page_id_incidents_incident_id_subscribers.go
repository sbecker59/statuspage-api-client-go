...
func NewPostPagesPageIdIncidentsIncidentIdSubscribers() *PostPagesPageIdIncidentsIncidentIdSubscribers {
	this := PostPagesPageIdIncidentsIncidentIdSubscribers{}
	return &this
}
...
// SetSubscriber gets a reference to the given PostPagesPageIdIncidentsIncidentIdSubscribersSubscriber and assigns it to the Subscriber field.
...
type NullablePostPagesPageIdIncidentsIncidentIdSubscribers struct {
	value *PostPagesPageIdIncidentsIncidentIdSubscribers
	isSet bool
}

func (v NullablePostPagesPageIdIncidentsIncidentIdSubscribers) Get() *PostPagesPageIdIncidentsIncidentIdSubscribers {
	return v.value
}

func (v *NullablePostPagesPageIdIncidentsIncidentIdSubscribers) Set(val *PostPagesPageIdIncidentsIncidentIdSubscribers) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPagesPageIdIncidentsIncidentIdSubscribers) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPagesPageIdIncidentsIncidentIdSubscribers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPagesPageIdIncidentsIncidentIdSubscribers(val *PostPagesPageIdIncidentsIncidentIdSubscribers) *NullablePostPagesPageIdIncidentsIncidentIdSubscribers {
	return &NullablePostPagesPageIdIncidentsIncidentIdSubscribers{value: val, isSet: true}
}

func (v NullablePostPagesPageIdIncidentsIncidentIdSubscribers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPagesPageIdIncidentsIncidentIdSubscribers) UnmarshalJSON(src []byte) error {
	v.isSet = true
