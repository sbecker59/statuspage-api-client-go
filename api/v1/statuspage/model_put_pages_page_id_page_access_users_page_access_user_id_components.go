...
func NewPutPagesPageIdPageAccessUsersPageAccessUserIdComponents(componentIds []string) *PutPagesPageIdPageAccessUsersPageAccessUserIdComponents {
	this := PutPagesPageIdPageAccessUsersPageAccessUserIdComponents{}
...
type NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents struct {
	value *PutPagesPageIdPageAccessUsersPageAccessUserIdComponents
	isSet bool
}

func (v NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents) Get() *PutPagesPageIdPageAccessUsersPageAccessUserIdComponents {
	return v.value
}

func (v *NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents) Set(val *PutPagesPageIdPageAccessUsersPageAccessUserIdComponents) {
	v.value = val
	v.isSet = true
}

func (v NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents) IsSet() bool {
	return v.isSet
}

func (v *NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents(val *PutPagesPageIdPageAccessUsersPageAccessUserIdComponents) *NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents {
	return &NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents{value: val, isSet: true}
}

func (v NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutPagesPageIdPageAccessUsersPageAccessUserIdComponents) UnmarshalJSON(src []byte) error {
	v.isSet = true
