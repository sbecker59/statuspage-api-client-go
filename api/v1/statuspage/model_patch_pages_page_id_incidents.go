...
// checks if the PatchPagesPageIdIncidents type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchPagesPageIdIncidents{}

// PatchPagesPageIdIncidents Update an incident
type PatchPagesPageIdIncidents struct {
...
func NewPatchPagesPageIdIncidents() *PatchPagesPageIdIncidents {
	this := PatchPagesPageIdIncidents{}
	return &this
}
...
func (o PatchPagesPageIdIncidents) MarshalJSON() ([]byte, error) {
...
func (o PatchPagesPageIdIncidents) ToMap() (map[string]interface{}, error) {
...
type NullablePatchPagesPageIdIncidents struct {
	value *PatchPagesPageIdIncidents
	isSet bool
}

func (v NullablePatchPagesPageIdIncidents) Get() *PatchPagesPageIdIncidents {
	return v.value
}

func (v *NullablePatchPagesPageIdIncidents) Set(val *PatchPagesPageIdIncidents) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchPagesPageIdIncidents) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchPagesPageIdIncidents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchPagesPageIdIncidents(val *PatchPagesPageIdIncidents) *NullablePatchPagesPageIdIncidents {
	return &NullablePatchPagesPageIdIncidents{value: val, isSet: true}
}

func (v NullablePatchPagesPageIdIncidents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchPagesPageIdIncidents) UnmarshalJSON(src []byte) error {
	v.isSet = true
