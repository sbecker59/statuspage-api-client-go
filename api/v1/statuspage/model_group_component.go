...
// checks if the GroupComponent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupComponent{}
...
func (o GroupComponent) ToMap() (map[string]interface{}, error) {
