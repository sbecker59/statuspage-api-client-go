...
// checks if the PatchPagesPageIdSubscribers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchPagesPageIdSubscribers{}
...
func (o PatchPagesPageIdSubscribers) ToMap() (map[string]interface{}, error) {
