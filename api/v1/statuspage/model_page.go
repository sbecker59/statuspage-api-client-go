...
// SetActivityScore gets a reference to the given float32 and assigns it to the ActivityScore field.
...
// SetIpRestrictions gets a reference to the given string and assigns it to the IpRestrictions field.
