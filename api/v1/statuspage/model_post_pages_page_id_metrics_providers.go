...
func NewPostPagesPageIdMetricsProviders() *PostPagesPageIdMetricsProviders {
	this := PostPagesPageIdMetricsProviders{}
	return &this
}
...
// SetMetricsProvider gets a reference to the given PostPagesPageIdMetricsProvidersMetricsProvider and assigns it to the MetricsProvider field.
...
type NullablePostPagesPageIdMetricsProviders struct {
	value *PostPagesPageIdMetricsProviders
	isSet bool
}

func (v NullablePostPagesPageIdMetricsProviders) Get() *PostPagesPageIdMetricsProviders {
	return v.value
}

func (v *NullablePostPagesPageIdMetricsProviders) Set(val *PostPagesPageIdMetricsProviders) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPagesPageIdMetricsProviders) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPagesPageIdMetricsProviders) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPagesPageIdMetricsProviders(val *PostPagesPageIdMetricsProviders) *NullablePostPagesPageIdMetricsProviders {
	return &NullablePostPagesPageIdMetricsProviders{value: val, isSet: true}
}

func (v NullablePostPagesPageIdMetricsProviders) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPagesPageIdMetricsProviders) UnmarshalJSON(src []byte) error {
	v.isSet = true
