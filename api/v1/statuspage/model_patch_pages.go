...
// checks if the PatchPages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchPages{}
...
func (o PatchPages) ToMap() (map[string]interface{}, error) {
