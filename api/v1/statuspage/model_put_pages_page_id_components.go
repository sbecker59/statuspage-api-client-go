...
type NullablePutPagesPageIdComponents struct {
	value *PutPagesPageIdComponents
	isSet bool
}

func (v NullablePutPagesPageIdComponents) Get() *PutPagesPageIdComponents {
	return v.value
}

func (v *NullablePutPagesPageIdComponents) Set(val *PutPagesPageIdComponents) {
	v.value = val
	v.isSet = true
}

func (v NullablePutPagesPageIdComponents) IsSet() bool {
	return v.isSet
}

func (v *NullablePutPagesPageIdComponents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutPagesPageIdComponents(val *PutPagesPageIdComponents) *NullablePutPagesPageIdComponents {
	return &NullablePutPagesPageIdComponents{value: val, isSet: true}
}

func (v NullablePutPagesPageIdComponents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutPagesPageIdComponents) UnmarshalJSON(src []byte) error {
	v.isSet = true
