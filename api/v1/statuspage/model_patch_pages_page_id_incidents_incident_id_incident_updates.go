...
// checks if the PatchPagesPageIdIncidentsIncidentIdIncidentUpdates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchPagesPageIdIncidentsIncidentIdIncidentUpdates{}

// PatchPagesPageIdIncidentsIncidentIdIncidentUpdates Update a previous incident update
type PatchPagesPageIdIncidentsIncidentIdIncidentUpdates struct {
...
func NewPatchPagesPageIdIncidentsIncidentIdIncidentUpdates() *PatchPagesPageIdIncidentsIncidentIdIncidentUpdates {
	this := PatchPagesPageIdIncidentsIncidentIdIncidentUpdates{}
	return &this
}
...
func (o PatchPagesPageIdIncidentsIncidentIdIncidentUpdates) MarshalJSON() ([]byte, error) {
...
func (o PatchPagesPageIdIncidentsIncidentIdIncidentUpdates) ToMap() (map[string]interface{}, error) {
...
type NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates struct {
	value *PatchPagesPageIdIncidentsIncidentIdIncidentUpdates
	isSet bool
}

func (v NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates) Get() *PatchPagesPageIdIncidentsIncidentIdIncidentUpdates {
	return v.value
}

func (v *NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates) Set(val *PatchPagesPageIdIncidentsIncidentIdIncidentUpdates) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates(val *PatchPagesPageIdIncidentsIncidentIdIncidentUpdates) *NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates {
	return &NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates{value: val, isSet: true}
}

func (v NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchPagesPageIdIncidentsIncidentIdIncidentUpdates) UnmarshalJSON(src []byte) error {
	v.isSet = true
